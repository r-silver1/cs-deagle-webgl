...
class Vector3 {
    ...
    //helper function to return string rep of vector3
    static toString(other1){
        return ("[" + other1.elements[0].toString() + "], [" + other1.elements[1].toString() + "], [" + other1.elements[2].toString() + "]");
    }
}
